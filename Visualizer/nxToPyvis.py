...
def convert_to_pyvis(G, file_name, bg, font_color,file_label, view, physics, isHorizontal, download_dataset_only, csvRows, needsStabilization, select_edit_node_id, select_edit_node2_id):
  ...
  # the data is used to create an html file, args: data(network infor)/ file_name(name of the html file)/ bg(background selected by user-initially white)
    pyvisToHtml.convertToHtml(data, file_name, bg, file_label, view, isHorizontal, download_dataset_only, csvRows, needsStabilization, physics, select_edit_node_id,  select_edit_node2_id)
